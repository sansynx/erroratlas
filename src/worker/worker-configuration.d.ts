/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker/worker-configuration.d.ts` (hash: ed4ce24c2db909c235679645dce84fd3)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "APP_ORIGIN" | "PUBLIC_SUPABASE_URL" | "PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "WORKERS_AI_API_KEY" | "OPENAI_API_KEY" | "OPENAI_BASE_URL" | "OPENAI_MODEL" | "OPENAI_FAST_MODEL" | "OPENAI_TEXT_MODEL" | "SUPERMEMORY_PORT" | "FIELD_ENCRYPTION_KEY">> {}
}
